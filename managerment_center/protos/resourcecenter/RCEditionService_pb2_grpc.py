...
class RCEditionServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.listPress = channel.unary_unary(
        '/resourcecenter.RCEditionService/listPress',
        request_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
        response_deserializer=RCEditionService__pb2.ResponsePressList.FromString,
        )
    self.manageEditionVersion = channel.unary_unary(
        '/resourcecenter.RCEditionService/manageEditionVersion',
        request_serializer=RCEditionService__pb2.EditionVersionVo.SerializeToString,
        response_deserializer=RCCommon__pb2.EmptyResp.FromString,
        )
    self.listEditionVersionAA = channel.unary_unary(
        '/resourcecenter.RCEditionService/listEditionVersionAA',
        request_serializer=RCEditionService__pb2.RequestEditionVersionListAA.SerializeToString,
        response_deserializer=RCEditionService__pb2.ResponseEditionVersionListAA.FromString,
        )
...
class RCEditionServiceServicer(object):
  ...
  def manageEditionVersion(self, request, context):
    """增删改教材版本
    """
    context.set_code(grpc.StatusCode.UNIMPLEMENTED)
    context.set_details('Method not implemented!')
  ...
  def listEditionVersionAA(self, request, context):
    """分页查询教材版本列表
    """
    context.set_code(grpc.StatusCode.UNIMPLEMENTED)
    context.set_details('Method not implemented!')
...
def add_RCEditionServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'listPress': grpc.unary_unary_rpc_method_handler(
          ...
          response_serializer=RCEditionService__pb2.ResponsePressList.SerializeToString,
      ),
      'manageEditionVersion': grpc.unary_unary_rpc_method_handler(
          servicer.manageEditionVersion,
          request_deserializer=RCEditionService__pb2.EditionVersionVo.FromString,
          response_serializer=RCCommon__pb2.EmptyResp.SerializeToString,
      ),
      'listEditionVersionAA': grpc.unary_unary_rpc_method_handler(
          servicer.listEditionVersionAA,
          request_deserializer=RCEditionService__pb2.RequestEditionVersionListAA.FromString,
          response_serializer=RCEditionService__pb2.ResponseEditionVersionListAA.SerializeToString,
      ),
